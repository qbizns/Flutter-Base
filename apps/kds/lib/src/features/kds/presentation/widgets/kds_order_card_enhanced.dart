/// Enhanced KDS Order Card
/// Order card with progressive timer and animations
...
import 'progressive_timer.dart';

/// Enhanced KDS Order Card with progressive timer
class KdsOrderCardEnhanced extends StatefulWidget {
  final KitchenOrder order;
  final ValueChanged<KitchenOrderStatus> onStatusChange;
  final ValueChanged<KitchenOrderItem> onItemToggle;

  const KdsOrderCardEnhanced({
    super.key,
    required this.order,
  ...
  @override
  State<KdsOrderCardEnhanced> createState() => _KdsOrderCardEnhancedState();
}

class _KdsOrderCardEnhancedState extends State<KdsOrderCardEnhanced> {
  @override
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          // Header with order number, progressive timer, and table
          _buildHeader(),
  ...
  Widget _buildHeader() {
    return Container(
      ...
      decoration: BoxDecoration(
        color: widget.order.isOrderDelayed
            ? VodoColors.danger
      ...
      child: Column(
        children: [
          // Order number and progressive timer
          Row(
            ...
            children: [
              ...
              // Progressive timer
              ProgressiveTimer(
                startTime: widget.order.createdAt,
                normalThreshold: widget.order.isUrgent ? 5 : 10,
                warningThreshold: widget.order.isUrgent ? 10 : 15,
                fontSize: 14,
              ),
            ],
          ),
